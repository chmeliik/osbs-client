...
class BuildCommon(BuildParamsBase):
    ...
    def __init__(self, build_json_dir=None, **kwargs):
        # TODO: why is is build_json_dir special?
    ...
    def set_params(self,
        ...
        """
        # TODO: see if setting params from build_conf can be separated from setting other params,
        #   if yes, move most of this method to __init__
        if not build_conf:
    ...
    def to_dict(self, keys):
        ...
        for key in keys:
            ...
            # TODO: why are we not including falsy values?
            if value:
                retdict[key] = value
        return retdict
...
class BuildUserParams(BuildCommon):
    ...
    # TODO: see if this can (and should) be moved elsewhere
    ...
    def set_params(self,
        ...
        :param git_uri: str, uri of the git repository for the source
        """
        # TODO: see if setting params from build_conf and repo_info can be separated from setting
        #   other params, if yes, move most of this method to __init__
...
class SourceContainerUserParams(BuildCommon):
    ...
    def set_params(
        ...
        **kwargs
        ...
        :return:
        """
        # TODO: if the set_params methods of other classes can be scrapped, scrap this one too
