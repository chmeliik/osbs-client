...
class BuildCommon(BuildParamsBase):
    ...
    def make_params(cls,
        ...
        # Drop unknown kwargs, some callers may pass in deprecated params
        kwargs = {k: v for k, v in kwargs.items() if cls.get_param(k) is not None}
    ...
    def _make_params_super(cls, *args, **kwargs):
        # Pylint cannot properly infer the return type of an overriden classmethod
